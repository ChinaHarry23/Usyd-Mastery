...
function trackQuickCheckContext(context) {
  ...
  try {
    window.dispatchEvent(new CustomEvent("comp5318-progress-update"));
  } catch (e) {}
}
...
window.getComp5318ChapterProgress = function() {
  var p = getProgress();
  var data = p[chKey] || {};
...
refreshBindings();
window.addEventListener("comp5318-content-refresh", refreshBindings);
