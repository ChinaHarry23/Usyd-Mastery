    ...
    function callLLM() {
      ...
      function processSSE(response) {
        ...
        function scheduleRender() {
          ...
          renderTimer = requestAnimationFrame(function () {
            ...
            if (contentDirty) {
              contentDirty = false;
              bodyEl.innerHTML = md(contentText) + '<span class="stream-cursor">▊</span>';
      ...
      function finishStream() {
        ...
        if (!hasThinking) {
          ...
          thinkingEl.querySelector(".thinking-body").innerHTML = md(thinkingText);
        ...
        if (contentText) {
          bodyEl.innerHTML = md(contentText);
          tryRenderMath(bodyEl);
        } else if (thinkingText && !contentText) {
          bodyEl.innerHTML = md(thinkingText);
          tryRenderMath(bodyEl);
